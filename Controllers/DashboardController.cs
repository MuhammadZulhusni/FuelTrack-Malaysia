...
{
    // The following private fields are used for dependency injection & IHttpClientFactory is for creating HttpClient instances safely.
    private readonly IHttpClientFactory _httpClientFactory;
    // ILogger is for logging messages, warnings, and errors.
    private readonly ILogger<DashboardController> _logger;
    // IDistributedCache is for caching data to improve performance and reduce API calls.
